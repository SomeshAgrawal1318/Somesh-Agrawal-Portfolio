...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/SomeshAgrawal1318/Somesh-Agrawal-Portfolio)
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/SomeshAgrawal1318/Somesh-Agrawal-Portfolio.git
    cd Somesh-Agrawal-Portfolio
    ```
...
If you use this portfolio, a credit or link back to the [original repo](https://github.com/Naresh-Khatri/3d-portfolio) by Naresh Khatri would be much appreciated ❤️
